...
/*        mPlaceDetailsText.setText(formatPlaceDetails(getResources(), place.getName(), place.getId(),
    ...
    private void updateUI() {
        Log.i(TAG, "updateUI");
        if ("false".equals(mPreferences.getString("on_ride", "false")) && "false".equals(mPreferences.getString("requesting_ride", "false"))) {
            mBottomSheetBehavior.setPeekHeight(0);
            mBottomSheetBehavior.setState(BottomSheetBehavior.STATE_COLLAPSED);
            clearRoute();
        } else if ("true".equals(mPreferences.getString("on_ride", "false")) || "true".equals(mPreferences.getString("requesting_ride", "false"))) {
            mBottomSheetBehavior.setPeekHeight(50);
            mBottomSheetBehavior.setState(BottomSheetBehavior.STATE_EXPANDED);
            verifyRideState();
        }
